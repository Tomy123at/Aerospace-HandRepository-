...
#%%
print("CALCULADORA TABLA ISA")
print("Escoja una opción:")
print("1. Para calcular Temperatura, Presión, Densidad y Velocidad del Sonido ingresando Altitud")
print("2. Para calcular la altitud de la Temperatura, presión y densidad")
print("-------------------------------------------------------------------")
print("")
...
if option==1:
    print("")
    print("-------------------------------------------------------------------")
    inp = float(input("Ingrese la altitud[m]:  "))
    T_result, p_result, rho_result, a_result = Temp_Presion_Densidad(inp)
    print("Temperatura: ",T_result,"K   Presión: ",round(p_result,3),"Pa   Densidad: ",round(rho_result,6),"Kg/m3", "   Velocidad del Sonido: ",round(a_result,3), "m/s")

elif option==2:
    print("")
    print("-------------------------------------------------------------------")
    inp1 = float(input("Ingrese la temperatura:  "))
    inp2 = float(input("Ingrese la presión:  "))
    inp3 = float(input("Ingrese la densidad:  "))
    inp4 = float(input("Ingrese la sección:  "))
    hT_result, hP_result, hrho_result = TempPresDensALTITUDE(inp1,inp2,inp3,inp4)
    print("Altura de la Temperatura: ",hT_result,"m   Altura de la Presión: ",hP_result, "m   Altura de la Densidad: ",hrho_result,"m")
