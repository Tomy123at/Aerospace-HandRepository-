...
# MODIFICACIÓN: TREN DE ATERRIZAJE RETRAÍDO
...
data = [
    ...
    # === TREN RETRAÍDO: NLG y MLG en posiciones retraídas ===
    {'component': 'NLG (Retracted)', 'weight_lb': 38.00, 'x_mm': 1020, 'y_mm': 0, 'z_mm': 1550},
    {'component': 'MLG (Retracted)', 'weight_lb': 116.00, 'x_mm': 2800, 'y_mm': 0, 'z_mm': 1680},
...
print("--- Análisis de Peso y Balance: Tayrona I (TREN RETRAÍDO) ---")
print("\n--- 1. Condición de Peso Máximo al Despegue (MTOW) - TREN RETRAÍDO ---")
print("\nDesglose de Componentes y Momentos:")
print(df.to_string())
print("\n--- Resultados Finales (MTOW) - TREN RETRAÍDO ---")
print(f"Peso Máximo de Despegue (MTOW): {total_weight:,.2f} [lb]")
print("\nCentro de Gravedad (CG) en MTOW - TREN RETRAÍDO:")
...
empty_weight_components = ['Wing', 'Horizontal Tail', 'Vertical Tail', 'Fuselaje', 'NLG (Retracted)', 'MLG (Retracted)', 
...
print("\n\n--- 2. Límites del Centro de Gravedad (x_cg) para Escenarios Operacionales - TREN RETRAÍDO ---")
print(results_df.to_string(index=False))

# --- 6. Encontrar los Límites de la Envolvente ---
print("\n\n--- 3. Límites de la Envolvente x_cg - TREN RETRAÍDO ---")
...
print("\n\n--- 4. Límites de la Envolvente en %MAC - TREN RETRAÍDO ---")
...
print("\n--- Resultados Finales de la Envolvente (en %MAC) - TREN RETRAÍDO ---")
...
print("\n\n--- 5. Generando Diagrama de Envolvente - TREN RETRAÍDO ---")
...
ax.set_title('Diagrama de Envolvente (Excursión) de CG - Tayrona I (TREN RETRAÍDO)', fontsize=16)
...
print("\n\n--- 6. Verificación de Estabilidad Estática (Punto 3) - TREN RETRAÍDO ---")
...
print(f"\n--- Condición Más Estable (CG Adelantado) - TREN RETRAÍDO ---")
...
print(f"\n--- Condición Menos Estable (CG Atrasado) - TREN RETRAÍDO ---")
